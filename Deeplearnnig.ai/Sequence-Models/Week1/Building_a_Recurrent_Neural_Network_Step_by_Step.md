...
```
    ...
    gradients["dxt"].shape = (3, 10)
    gradients["da_prev"][2][3] = -0.8716697823439784
    gradients["da_prev"].shape = (5, 10)
...
```
    ...
    gradients["dx"].shape = (3, 10, 4)
    gradients["da0"][2][3] = 0.0015034270214428665
    gradients["da0"].shape = (5, 10)
    gradients["dWf"][3][1] = -0.06619212610612196
    gradients["dWf"].shape = (5, 8)
    gradients["dWi"][1][2] = 0.007230617857824084
    gradients["dWi"].shape = (5, 8)
    gradients["dWc"][3][1] = -0.05942903763697429
    gradients["dWc"].shape = (5, 8)
